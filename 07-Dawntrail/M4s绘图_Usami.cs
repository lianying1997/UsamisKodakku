...
{
    [ScriptType(name: "M4s绘图+", territorys:[1232], guid: "91c5cf80-c7c1-43d5-a115-a6431835e27d", version:"0.0.0.12.alpha", author: "Karlin", note: "Original code by Karlin, minor adjustments by Usami. \n基于原v0.0.0.12版本调整个人风格的钢月四连指路间隔，与日落黄圈引导。")]
    public class M4s绘图绘图
    {
        ...
        public void 雷电buff分散站位(Event @event, ScriptAccessory accessory)
        {
            ...
            dp1.Name = "跳跃引导-1";
            dp1.Scale = new(6);
            dp1.Color = imP1lighting? accessory.Data.DefaultDangerColor: accessory.Data.DefaultSafeColor;
