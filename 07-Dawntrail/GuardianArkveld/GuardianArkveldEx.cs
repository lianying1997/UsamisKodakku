...
namespace KodakkuScripts.Scripts._07_Dawntrail.GuardianArkveldEx;

// ????
[ScriptType(name: Name, territorys: [12345], guid: "42ee68e2-2a34-42dd-837c-620215de55d4",
...
public class GuardianArkveldEx
{
    ...
    private const string Name = "GuardianArkveld-Ex [护锁刃龙上位狩猎战]";
    ...
    [ScriptMethod(name: "锁刃敲打", eventType: EventTypeEnum.NpcYell, eventCondition: ["HelloayaWorld:asdf"],
        userControl: Debugging)]
    public void ChainbladeBlow(Event ev, ScriptAccessory sa)
    {
        sa.DrawRect(ev.SourceId, 0, 6000, $"锁刃敲打一", 0, 40, 4);
    }
